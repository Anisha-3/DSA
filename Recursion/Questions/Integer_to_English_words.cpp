...
/* Time Complexity is proportional to no. of words generated which is further proportional to no. of digits.
One digit can be represented by atmost 2 words
Number of digit = ceil(log(base 10) N)
